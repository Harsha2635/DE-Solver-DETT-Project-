...
# Solve the differential equation using RK2
t_values_rk2, i_values_rk2 = solve_rk2(rl_circuit, t0, t_end, i0, h)

# Plot the current response
plt.figure(figsize=(10, 6))
plt.plot(t_values_rk2, i_values_rk2, label='RK2: Current through inductor')
