...
lib.rk4.restype = None  # No return value
...
# Call the C function
lib.rk4(c_f, t0, t_end, i0, h, V0, R, L, t_values, i_values)
...
plt.plot(t_np, i_np, label="RK4 Approximation", linewidth=1.5)
plt.xlabel("Time ")
plt.ylabel("Current ")
